...
export default function Country() {
  ...
  const submitHandler = async (event) => {
    ...
    const format = formatFormData("tblLocation", formData, mode.formId);
  ...
  useEffect(() => {
    async function fetchFormHandler() {
      if (mode.formId) {
        ...
        const format = formatFetchForm(data, "tblLocation", mode.formId);
