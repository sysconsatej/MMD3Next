...
import data, { metaData } from "./instantDoReportData";
...
export default function InstantDoReport() {
    ...
    () =>
      createHandleChangeEventFunction({
        setFormData,
        fields: jsonData.doRegisterFields,
      }),
    [setFormData, jsonData.doRegisterFields]
  );
    return (
