...
import data, { metaData } from "./jobOrderData";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const requestBody = {
        ...
        jsonData: {
          ...formattedForApi,
          shippingLineId: formData?.shippingLineId?.Id ?? userData.companyId,
        },
      };
      ...
      <form onSubmit={handleSubmit}>
        <section className="py-1 px-4">
          <Box className="flex justify-between items-end py-1">
            <h1 className="text-left text-base m-0">Job Order</h1>
          </Box>
